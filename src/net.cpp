...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CTz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "ctz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "ctz.bitcommoditiz.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "testnet.ctz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "testnet.ctz.bitcommoditiz.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CTz is probably already running."), addrBind.ToString().c_str());
        else
